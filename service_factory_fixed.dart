...
import '../../domain/services/farm_activity_service.dart';
import '../../domain/services/farm_activity_sync_service.dart';
...
class ServiceFactory {
  ...
  static SyncService<FarmActivity> createFarmActivitySyncService() {
    final repository =
        RepositoryFactory.createFarmActivityRepository()
            as FarmActivityRepository;
    final syncStatusRepository = SyncStatusRepository();
    final connectivityHelper = ConnectivityHelper();

    return FarmActivitySyncService(
      localRepository: repository,
      syncStatusRepository: syncStatusRepository,
      connectivityHelper: connectivityHelper,
    );
  ...
  static SyncManager createSyncManager() {
    return SyncManager(
      ...
      farmActivitySyncService: createFarmActivitySyncService(),
    );
  }
}
